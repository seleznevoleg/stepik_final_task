...
class ProductPage(BasePage):
    ...
    def success_message_is_not_displayed (self):
        assert self.is_not_element_present(*ProductPageLocators.ADD_SUCCESS_MESSAGE),\
            "Success message is presented"
        
    def success_message_is_desapeared (self):
        assert self.is_disappeared(*ProductPageLocators.ADD_SUCCESS_MESSAGE),\
